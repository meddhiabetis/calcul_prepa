...
class Ccrsst extends StatefulWidget {
  const Ccrsst({Key? key}) : super(key: key);

  @override
  State<Ccrsst> createState() => _CcrsstState();
}

class _CcrsstState extends State<Ccrsst> {
    static double? e_alg ;
  static double? t_alg ;
  ...
  void doCalc(
    ...
    setState(() {
      mo = (5 * (0.15 * tAlg + 0.35 * dsAlg + 0.5 * eAlg) +
              ...
              3 * (0.15 * tMsi + 0.35 * dsMsi + 0.5 * eMsi) +
              1.8*(0.15*tfab+0.35*dsfab+0.5*efab)+
              4.2*(0.15*tcon+0.35*dscon+0.5*econ)+
              4 * (0.15 * tChimie + 0.35 * dsChimie + 0.5 * eChimie) +
              4 * (0.15 * tInf + 0.35 * dsInf + 0.5 * eInf) +
              3 * (0.15 * tAuto + 0.35 * dsAuto + 0.5 * eAuto) +
